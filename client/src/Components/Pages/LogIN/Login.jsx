...
function Login({ showSignUp}) {
  ...
  return <div class="main-wrapper log-wrap">
      <div class="row">
        ...
        <div class="col-lg-6 hello2 d-flex login-wrap-bg ">
          <div class="login-wrapper">
            <div class="loginbox hello2 ">
              <div class="w-100 ">
                <p className="p1">Login to your account</p>
                <p className="p2 text-center">
                  Don't have an account?<Link to="/signup" className="a3">
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div class="google-bg text-center">
                    <p>
                      New User ? <Link to="/signup" className="a3">
                        Create a new account
                      </Link>
                    </p>
                  </div>
