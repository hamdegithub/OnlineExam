...
const AmharicAdmin = () => {
  ...
  const renderQuestionPage = () => {
    ...
    const handleDelete = () => {
      axios
        .delete(`/api/amharic/deletequestion${currentQuestion.onlinequestion_id}`)
        .then((response) => {
          loadQuestions()
          renderQuestionPage()
          showToastMessage()
  ...
  return (
    <section className="container">
      <h1 className="text-center pt-2">Grade 8 Amharic Matric Exam</h1>
      {showScore ? (
        renderScorePage()
      ) : questions.length > 0 ? (
        renderQuestionPage()
