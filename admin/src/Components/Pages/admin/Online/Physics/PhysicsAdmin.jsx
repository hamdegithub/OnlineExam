...
const PhysicsAdmin = () => {
  ...
  const renderQuestionPage = () => {
    ...
    const handleDelete = () => {
      axios
        .delete(`/api/physics/deletequestion${currentQuestion.onlinequestion_id}`)
        .then((response) => {
          loadQuestions()
          renderQuestionPage()
          showToastMessage()
  ...
  return (
    <section className="container">
      <h1 className="text-center pt-2">Grade 8 Physics Matric Exam</h1>
      {showScore ? (
        renderScorePage()
      ) : questions.length > 0 ? (
        renderQuestionPage()
